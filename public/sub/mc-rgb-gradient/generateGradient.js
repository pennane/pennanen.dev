...
// Coordinated to work with my spaghetti
// cheers


export default function generateGradient(color1, color2, stepsAmount) {
    // elements for obtaining vals
    var val1El = color1;
    var val2El = color2;
    var stepsEl = stepsAmount;
    ...
    function updateSpitter() {
        ...
        var stepsInt = parseInt(stepsEl.value, 10);
