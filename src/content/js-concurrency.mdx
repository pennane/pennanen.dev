...
The implementation might look a bit intimidating, but in essence: boom -- promises, handled are as soon as they resolve.
...
In that case the generator can simply be composed further with familiar JavaScript promise semantics.
